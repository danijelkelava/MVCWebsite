  ...
  <div class="row">
    ...
    <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
      ...
      <div class="form-group">
        ...
        <p class="text-danger"><?php if(isset($data['errors']['ime'])){ echo $data['errors']['ime']; } ?></p>
      </div>
      ...
      <div class="form-group">
        ...
        <p class="text-danger"><?php if(isset($data['errors']['prezime'])){ echo $data['errors']['prezime']; } ?></p>
      </div>
